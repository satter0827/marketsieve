...
.PHONY: help sync format format-check lint typecheck test check doctor build review review-bundle review-validate release-build release-verify release-check clean-generated
